...
class Operazione(Base):
    ...
    ID_Operazione = Column("ID_Operazione", Integer, primary_key=True, nullable=False, autoincrement=True)
    ...
    def __init__(self, ID_Operazione : int, ID_Telegram : str, ID_Auletta : int, ID_Prodotto : int, dateTimeOperazione : DateTime, costo):
