...
def GetProdotti(idAuletta : int) -> str:
    ...
    res2 = session.query(Magazzino, Prodotto).select_from(Magazzino).join(Prodotto, Magazzino.ID_Prodotto == Prodotto.ID_Prodotto, isouter=True).filter(Magazzino.ID_Auletta == idAuletta)
